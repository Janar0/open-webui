...
app.state.config.ENABLE_MARKETPLACE = ENABLE_MARKETPLACE
app.state.config.CLAWHUB_API_URL = CLAWHUB_API_URL
app.state.config.CLAWHUB_API_TOKEN = CLAWHUB_API_TOKEN
...
app.state.config.REALTIME_STT_ENABLED = REALTIME_STT_ENABLED
app.state.config.REALTIME_SUMMARY_MODEL = REALTIME_SUMMARY_MODEL
app.state.config.REALTIME_SUMMARY_PROMPT = REALTIME_SUMMARY_PROMPT
...
app.state.config.DETECT_ARTIFACTS = DETECT_ARTIFACTS
app.state.config.IFRAME_SANDBOX_ALLOW_SAME_ORIGIN = IFRAME_SANDBOX_ALLOW_SAME_ORIGIN
app.state.config.IFRAME_SANDBOX_ALLOW_FORMS = IFRAME_SANDBOX_ALLOW_FORMS
            ...
            **(
                {
                    ...
                    "enable_marketplace": app.state.config.ENABLE_MARKETPLACE,
